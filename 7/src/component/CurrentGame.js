    ...
    if (currentGame) {
        ...
        if (currentGame.mode == lib.GameMode.InProgress) {
            markup = <Game Operand1={currentGame.expression.lhs}
                ...
                Histories={currentGame.currentHistories} SkipVisibility={currentGame.skipVisibility}
                onSkip={props.onSkip} gamesDic={props.gamesDic}></Game>;
            ...
            markup = <GameResult Duration={currentGame.gameDuration} Histories={props.histories}
                onNew={props.onNewGame} gamesDic={props.gamesDic}></GameResult>;
        }
